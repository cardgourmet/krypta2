    ...
    <>
      <nav className={`${styles.mobileSidebar} ${sidebarOpen ? styles.shown : ''}`} ref={sidebarRef}>
        ...
        <div className={styles.mobileSidebarBottom}>
          ...
          >
            <MTGIcon height={24} width={24} color={'var(--gourmet-neutral-8)'} />
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
          >
            <PCGIcon height={24} width={24} color={'var(--gourmet-neutral-8)'} />
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
          >
            <DLCIcon height={24} width={24} color={'var(--gourmet-neutral-8)'} />
            <p>Disney Lorcana</p>
          </Link>
        </div>
      </nav>
