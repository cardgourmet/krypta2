...
export function DlcRarityEnchanted({ size, style, ...others }: DlcRarityIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 120.3 140.65"
      fill="currentColor"
      stroke="currentColor"
      style={{ width: rem(size), height: rem(size), strokeWidth: 0, ...style }}
      {...others}
    >
      <title>dlc-rarity-enchanted</title>
      <path
        className="cls-1"
      ...
      <path
        className="cls-1"
        d="m120.1,93.94c-9.33-1.84-18.1-4.89-26.75-9.44,8.58-4.76,17.36-8.15,26.75-10.33v19.77Z"
      />
    </svg>
  );
}
