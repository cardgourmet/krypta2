    ...
    <Stack>
      ...
      {edit && (
        ...
        >
          <Stack>
            <Group>
              <input name="Username" type="text" value={user?.username} autoComplete={'username'} hidden />
...
function EmailSetting() {
  ...
  const [emailPending, setEmailPending] = useLocalStorage<string | null>({
    key: CGM_EMAIL_PENDING,
  });
