...
export const dlcAdvancedFilters: Record<string, AdvancedFilterCategory> = {
  identity: {
    icon: <IconUserScan />,
    filters: [
      {
...
type DlcAdvancedFilterFormData = {
  name: {
    search: string;
    exact: boolean;
  };
...
export function generateDlcFilterComponents(filter: AdvancedFilter): ReactElement {
  console.log({} as DlcAdvancedFilterFormData);
